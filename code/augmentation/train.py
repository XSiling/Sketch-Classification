...
if __name__ == '__main__':
    ...
    # pdb.set_trace()
    train_X_rotate1, train_Y_rotate1 = generate_flip(train_X,train_Y,0.3)

    train_X = torch.cat((train_X, train_X_rotate1), dim=0)
    train_Y = torch.cat((train_Y, train_Y_rotate1),dim=0)
    ...
    if args.method == 'VGG':
        model = models.VGG.VGG().to(DEVICE)
